...
class RegenerarQRController extends Controller
{
    ...
    private function generarPDFLote($lote)
    {
        ...
        $pdf = Pdf::loadView('welding_tracking_views.qr_lote_pdf', compact('lote', 'qrContent'));
    ...
    private function generarPDFIndividuales($botes, $lote)
    {
        ...
        $pdf = Pdf::loadView('welding_tracking_views.qr_individuales_pdf', compact('qrCodes', 'lote'));
