...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('CandadoObturador_cnominal')) {
            Schema::create('CandadoObturador_cnominal', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('CandadoObturador_cnominal');
    }
};
