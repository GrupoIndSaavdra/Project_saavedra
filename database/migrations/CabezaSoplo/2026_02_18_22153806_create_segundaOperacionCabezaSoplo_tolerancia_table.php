...
return new class extends Migration
{
    ...
    {
        if (!Schema::hasTable('segundaOperacionCabezaSoplo_tolerancia')) {
            Schema::create('segundaOperacionCabezaSoplo_tolerancia', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('segundaOperacionCabezaSoplo_tolerancia');
    }
};
