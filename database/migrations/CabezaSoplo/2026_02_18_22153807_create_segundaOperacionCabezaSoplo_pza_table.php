...
return new class extends Migration {
    ...
    {
        if (!Schema::hasTable('segundaOperacionCabezaSoplo_pza')) {
            Schema::create('segundaOperacionCabezaSoplo_pza', function (Blueprint $table) {
                $table->id();
                ...
                $table->foreign('id_proceso')->references('id')->on('segundaOperacionCabezaSoplo');
            });
        }
    }
    ...
    {
        Schema::dropIfExists('segundaOperacionCabezaSoplo_pza');
    }
};
