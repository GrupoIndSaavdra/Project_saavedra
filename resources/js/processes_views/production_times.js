    ...
    if (select.value != 0) {
        switch (select.value) {
            ...
            case "Fondo":
                ...
                break;
            case "Corona":
                procesos = ["Cepillado", "Desbaste-exterior", "Primera Operacion", "Segunda Operacion", "Soldadura", "Soldadura PTA", "Rectificado", "Asentado", "Calificado", "Acabado-Bombillo"];
                procesosDB = ["cepillado", "desbaste", "pOperacion", "sOperacion", "soldadura", "soldaduraPTA", "rectificado", "asentado", "calificado", "acabadoBombillo"];
                break;
            case "Plato":
