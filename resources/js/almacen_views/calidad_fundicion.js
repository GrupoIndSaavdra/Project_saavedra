...
function _libActualizarBotonesAccion(decision) {
    ...
    if (decision === "aprobar") {
        ...
        nuevoBtn.style.cssText =
            "flex:1; min-width:200px; max-width:380px; justify-content:center; display:flex; gap:8px; align-items:center; font-size:1.15em; padding:14px 28px; border-radius:10px; font-family:'Poppins',sans-serif; font-weight:700; height:auto;";
        nuevoBtn.innerHTML =
            '<img src="' +
...
window.abrirModalEnviarAlertaLiberacion = function (ot, decision, tiposAprobados, tiposRechazados, isAlmacen = false) {
    ...
    if (colA) colA.style.display = hasAprobado ? "block" : "none";
    const colR = document.getElementById("al-col-rechazados");
    if (colR) colR.style.display = hasRechazado ? "block" : "none";
