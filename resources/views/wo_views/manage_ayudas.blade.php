        ...
        <div class="dibujos-dashboard-layout">
            ...
            <div class="dibujos-card">
                ...
                @php
                    ...
                    if ($moduleType === 'ayudas' && $procesoSeleccionadoId && $procesoActivo) {
                        $isReady = true;
                                        ...
                                        <td class="d-text-center">
                                            <div class="td-actions">
                                                <button class="btn-action-icon btn-ver-archivos" title="Ver archivos"
                                                    onclick="irACarpeta({{ \Illuminate\Support\Js::from($procesoIdBD ?? $procesoName) }}, null, {{ $procesoIdBD ? 'true' : 'false' }})">
