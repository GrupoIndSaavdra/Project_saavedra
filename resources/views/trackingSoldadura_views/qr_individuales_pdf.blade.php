...
<body>
    <div class="header">
        ...
        <p style="font-size: 8px; margin: 5px 0;">Lote: {{ $lote->matricula }} | {{ $lote->nombre }} - {{ $lote->lote }}
            | Total: {{ count($qrCodes) }} botes</p>
    </div>
            ...
            <div class="qr-item">
                ...
                <div class="qr-info">
                    <table>
                        <tr>
                            <td>Matrícula:</td>
                            <td>{{ $item['bote']->matricula }}</td>
                        </tr>
                        <tr>
                            <td>Soldadura:</td>
                            <td>{{ $item['bote']->lote->nombre }}</td>
                        </tr>
                        <tr>
                            <td>Lote:</td>
                            <td>{{ $item['bote']->lote->lote }}</td>
                        </tr>
                        <tr>
                            <td>Peso:</td>
                            <td>{{ $item['bote']->peso_kg }}kg</td>
                        </tr>
                    </table>
                </div>
            </div>
