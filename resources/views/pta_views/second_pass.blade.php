...
@section('head')
    ...
    @vite(['resources/css/pta_views/analysis.css', 'resources/css/processes_views/welding_pta_table_partial.css', 'resources/css/pta_views/second_pass.css'])
@endsection
    ...
    <div class="pta-analysis-wrapper">
        ...
        @if ($piezasGroup && $piezasGroup->isNotEmpty())
            ...
            <div class="seg-margin-bottom-1-5rem">
                ...
                <form method="POST" action="{{ route('pta.second_pass.update') }}" id="form-p2"
    ...
    <script>
        ...
        function onClaseChange() {
            ...
            if (claseId) {
                ...
                window.location.href = `{{ route('pta.second_pass') }}?ot_id=${otId}&clase_id=${claseId}`;
            }
        }
        ...
        function onPiezaChange() {
            ...
            if (nPieza) {
                window.location.href = `{{ route('pta.second_pass') }}?ot_id=${otId}&clase_id=${claseId}&n_pieza=${nPieza}`;
            }
        }
