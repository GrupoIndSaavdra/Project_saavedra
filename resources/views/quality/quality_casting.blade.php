...
@section ("content")
            ...
            <div class="alm-modal-body cal-padding-3em-3-5em">
                ...
                <form id="formEnviarAlertaLiberacion" enctype="multipart/form-data" novalidate>
                    ...
                    <div id="al-dual-layout"
                        ...
                        {{-- ── COLUMNA APROBADOS ── --}}
                        <div id="al-col-aprobados" class="cal-flex-1 cal-width-100pct hidden">
                            <div
                        ...
                        {{-- ── COLUMNA RECHAZADOS ── --}}
                        <div id="al-col-rechazados" class="cal-flex-1 cal-width-100pct hidden">
                            <div
    ...
    <div id="modalFinalizarCalidad" class="alm-modal" role="dialog" aria-modal="true">
        ...
        <div class="alm-modal-content cal-max-width-1500px cal-width-95vw cal-border-radius-20px cal-overflow-hidden">
            ...
            <div
                ...
                <div class="div-cerrar">
                    <button type="button"
                        class="btn-cerrar cal-position-absolute cal-top-18px cal-right-22px cal-background-rgba-255-255-255-0-18 cal-border-1-5px-solid-rgba-255-255-255-0-45 cal-border-radius-50pct cal-width-36px cal-height-36px cal-display-inline-flex cal-align-items-center cal-justify-content-center cal-cursor-pointer cal-transition-all-0-2s-ease">
    ...
    @include ("warehouse.partials._modal_model_release")
