                                    ...
                                    <tbody id="alm-tbody-{{ $estado }}">
                                        ...
                                        @foreach ($registrosEstado as $reg)
                                            ...
                                            @php
                                                ...
                                                $rejectedClassesForOt = \App\Models\LiberacionModeloFundicion::where('ot', $otParaRechazados)
                                                ...
                                                $count = count($archivos) + count($rechazadosDibujos) + count($ayudasArchivos) + count($rechazadosAyudas) + count($archivosAprobados) + count($archivosRechazados) + count($rechazadosOtros);
