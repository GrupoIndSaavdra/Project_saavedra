...
@section('head')
    <title>Reportes de Calidad — Control Dimensional | GIS</title>
    <meta name="description" content="Reporte de inspección y control dimensional de piezas. Grupo Industrial Saavedra.">
    @vite([
...
<div class="alm-wrapper">
    ...
    <div class="alm-header">
        <div class="alm-header-left">
            <div class="alm-header-icon">
                <img src="{{ asset('images/reporte dimensional.png') }}" alt="Reporte Dimensional" class="ri-header-icon-img">
            </div>
            <div class="alm-header-text">
                <h1>Reporte de Calidad — Reporte Dimensional</h1>
                <p>Control dimensional y verificación de tolerancias de piezas. Selecciona una OT para comenzar.</p>
            </div>
        </div>
        <div class="reportes-nav-tabs">
            <a href="{{ route('calidad.inspeccion_visual.index') }}" class="reporte-tab" id="tab-visual">
                <img src="{{ asset('images/reporte Volumetrico.png') }}" alt="" class="tab-icon"> Reporte Volumétrico
            </a>
            <a href="{{ route('calidad.inspeccion_dimensional.index') }}" class="reporte-tab active" id="tab-dimensional">
    ...
    <div class="alm-table-card">
        <div class="alm-table-header">
            ...
            <span class="alm-results-count">Selecciona la OT y la clase para abrir el reporte dimensional o volumétrico</span>
        </div>
        ...
        <div class="ri-search-form-wrapper">
            <form id="form-abrir-reporte" class="ri-search-form" onsubmit="return false;">
                ...
                <div class="ri-form-group-actions" id="grupo-btn-abrir" style="display:none;">
                    ...
                    <button type="button" id="btn-abrir-visual" class="btn-abrir btn-abrir-secondary">
            ...
            <table class="alm-table" id="tabla-reportes">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('calidad.inspeccion_dimensional.show', ['ot' => $rep->ot_id, 'clase' => $rep->clase]) }}" class="btn-ver-reporte">
                                <img src="{{ asset('images/reporte dimensional.png') }}" width="16" height="16" style="object-fit: contain;"> Ver Reporte Dimensional
                            </a>
                        </td>
                    </tr>
                    @endforeach
