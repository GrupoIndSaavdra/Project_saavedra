...
@section('content')
    <div class="container-meta">
        ...
        <div class="div-table-meta">
            ...
            <label class="warning-pieces">ESTAMOS TRABAJANDO PARA SOLUCIONAR PROBLEMAS DEL SOFTWARE PORFAVOR, SI TIENES UN
                ERROR RESPECTO AL SOFTWARE COMENTA AL ÁREA CORRESPONDIENTE, NO DESCONECTES LAS MÁQUINAS Y AL REALIZAR TU
                REPORTE SELECCIONA EL NÚMERO DE MÁQUINA EN LA QUE LABORAS❗ </label>
        </div>
