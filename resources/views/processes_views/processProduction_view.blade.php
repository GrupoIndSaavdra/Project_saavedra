...
@section('content')
    <div class="container-meta">
        ...
        <div class="div-table-meta">
            ...
            <label class="warning-pieces">LAS COTAS NOMINALES EN EL SOFTWARE SON SOLO DE REFERENCIA; CUALQUIER DUDA, VERIFICAR CON CALIDAD O PROGRAMACIÓN. LA 1ER PZA DEBE SER REVISADA Y LIBERADA POR CALIDAD ANTES DE CONTINUAR; Y REALIZAR LA MISMA VERIFICACIÓN CADA 5 PZS. SI EL OPERADOR DETECTA UN ERROR EN LAS MEDIDAS DURANTE EL REGISTRO, DEBERÁ NOTIFICAR DE INMEDIATO A UN ADMINISTRADOR PARA EL DESBLOQUEO DE CAMPOS, LIBERACIÓN DE MÁQUINAS O ATENCIÓN DE PIEZAS INCOMPLETAS/PENDIENTES. LOS ERRORES DE SOFTWARE DEBERÁN SER REPORTADOS AL DPTO DE CORRESPONDIENTE PARA SU SOLUCIÓN.</label>
        </div>
